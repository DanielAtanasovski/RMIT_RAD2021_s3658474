...
black_male_shirt = Item.create!({name: 'Black Male Shirt', price: 20.99, popularity: 10})
...
red_male_shirt = Item.create!({name: 'Red Male Shirt', price: 9.99, popularity: 2})
...
peach_women_shirt = Item.create!({name: 'Peach Women Shirt', price: 11.99, popularity: 5})
...
pink_women_shirt = Item.create!({name: 'Pink Women Shirt', price: 17.49, popularity: 5})
...
grey_children_shirt = Item.create!({name: 'Grey Children Shirt', price: 14.99, popularity: 5})
